...
class Frame(tk.Frame):
    ...
    def create_button(self):
        ...
        self.step = tk.Button(self,text="一世代進める",command=lg.step_generation )
...
class LifeGame(Rect):
    def __init__(self):
        self.fierd = [DEAD for i in range(NUM_ROW*NUM_COL)]
        self.current_field = [DEAD for i in range(NUM_ROW*NUM_COL)]
        self.generation = 0
        self.run = False
